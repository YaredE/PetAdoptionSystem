...
public class IntakeRescuePage extends Composite 
{
     ...
     * @param _paoService
     */
    public IntakeRescuePage(PetAdoptionOrganizationServiceAsync _paoService)
    {
    ...
    class AnimalRegistrationHandler implements ClickHandler
    {
		...
		{	
			...
			try
			{
				...
				if ( paoService != null )
				{
					paoService.recordAnimalByRescue(petInformation, new RecordAnimalByRescueCallBackHandler());	 
				}
			}
			catch ( Exception ex )
			{
     ...
     *
     */
    private class RecordAnimalByRescueCallBackHandler implements AsyncCallback<String> {
