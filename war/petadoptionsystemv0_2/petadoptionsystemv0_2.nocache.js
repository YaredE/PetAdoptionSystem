...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "petadoptionsystemv0_2" because\n';
  ...
  $wnd.__gwt_activeModules['petadoptionsystemv0_2'] = {
    'moduleName' : 'petadoptionsystemv0_2',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/petadoptionsystemv0_2.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['petadoptionsystemv0_2'].superdevmode = true;

  var expectedSuffix = '/petadoptionsystemv0_2.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + petadoptionsystemv0_2 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:petadoptionsystemv0_2';
  var devModeSessionKey = '__gwtDevModeSession:petadoptionsystemv0_2';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/petadoptionsystemv0_2/petadoptionsystemv0_2.nocache.js';
  ...
  $wnd.__gwt_activeModules['petadoptionsystemv0_2'].canRedirect = true;
  $wnd.__gwt_activeModules['petadoptionsystemv0_2'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING petadoptionsystemv0_2';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/petadoptionsystemv0_2?user.agent=' + ua + '&_callback=' + callback;
